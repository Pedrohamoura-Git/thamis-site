  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-400 ease-in-out ${
        ...
        isScrolled ? "bg-primary py-0" : "bg-accent py-8"
      }`}
    >
      <div className="container mx-auto px-6 py-3 md:flex md:items-center md:justify-between md:p-5">
        <div className="flex items-center justify-between">
          <div className="logo">
            <Logo
              ...
              height={40}
              fill="white"
              className={`${isScrolled ? "h-10 w-10" : "h-16 w-16"}`}
            />
          </div>
